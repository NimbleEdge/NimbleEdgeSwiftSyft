...
//        Datadog.verbosityLevel = .info
        ...
        if let deviceIdentifier = deviceToken {
            ...
            self.deviceToken = deviceIdentifier

        // Else check unique device token generated by syft client is ready
        } else if let syftGeneratedDeviceToken = UserDefaults.standard.string(forKey: "NimbleEdgeSwiftSyft-deviceToken") {

            self.deviceToken = syftGeneratedDeviceToken
